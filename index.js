...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['check_guess'] != 'undefined', 'missing Wasm export: check_guess');
  ...
  _init_game = Module['_init_game'] = createExportWrapper('init_game', wasmExports['init_game'], 0);
  _check_guess = Module['_check_guess'] = createExportWrapper('check_guess', wasmExports['check_guess'], 2);
